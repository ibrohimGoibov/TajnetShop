...
const Layout = () => {
  ...
  playsInline
/>
          <button className='px-[20px] py-[10px] bg-violet-200 text-violet-400'>Katalog</button>
          <div className="flex items-center justify-between gap-[10px] w-[500px] h-[40px] border px-[30px] py-[10px]">
  ...
  <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z"/>
        ...
        <footer>
          <div className="flex items-start mt-[50px] justify-evenly p-[20px]">
            <div className="num1">
              <h2 className='text-[17px] font-[600]'>О нас</h2>
              <p className='mt-[10px] text-gray-400'>О нас</p>
              <p className='mt-[10px] text-gray-400'>Вакансии</p>
            </div>
            <div className="num1">
              <h2 className='text-[17px] font-[600]'>Пользователям</h2>
              <p className='mt-[10px] text-gray-400'>Связаться с нами</p>
              <p className='mt-[10px] text-gray-400'>опрос - Ответ</p>
            </div>
            <div className="num1">
              <h2 className='text-[17px] font-[600]'>Для предпринимателей</h2>
              <p className='mt-[10px] text-gray-400'>Продавайте на Uzum</p>
              <p className='mt-[10px] text-gray-400'>Вход для продавцов</p>
              <p className='mt-[10px] text-gray-400'>Открыть пункт выдачи</p>
            </div>
            <div className="num1">
              <h2 className='text-[17px] font-[600]'>Скачать приложение</h2>
              <div className="flex items-center gap-[30px]">
                <div className="num1 flex items-center gap-[10px]">
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-apple" viewBox="0 0 16 16">
...
<a href="https://t.me/@BRAWLSTORESH">
